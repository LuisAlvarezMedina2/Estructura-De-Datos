...
public class MAINlibro {
    public static void main(String[] Args){
        ...
        Libro libro3 = new Libro("Felipe", 300,25,"CalculoI", "Matematica");
        Libro libro4 = new Libro("Felipe", 300,30,"Electricidad", "Fiscia");
    ...
    public static void cambioDePilas(PilaLibros pilaA, PilaLibros pilaB){
        ...
        while (!pilaB.esVacio()){
            ...
            EliminarB = pilaB.eliminar();

            if(EliminarB.getPrecio() == maxB){
                libroB = EliminarB;
            }
            auxB.adicionar(EliminarB);
